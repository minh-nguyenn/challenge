...
export default {
  ...
  data() {
    return {
      relatedProducts: []
      // blogDetail bo khoi data(): gia tri that den tu setup()/useAsyncData.
      // Neu khai bao o day, data() ghi de gia tri cua setup() -> template doc {}
    }
  },
  ...
  ::v-deep {
    ...
    h4:has(strong) {
      ...
      @media screen and (max-width: 768px) {
        margin-bottom: 25px;
        padding: 10px 0;
        border-bottom: 1px dashed #331E0E;
        font-weight: bold;
        font-size: 14px;
        line-height: 1.6;
      }
    ...
    h3 {
      ...
      @media screen and (max-width: 768px) {
        ...
        border-bottom: 3px solid #331E0E;
        font-weight: bold;
        color: #331E0E;
        font-size: 14px;
        padding-left: 0px;
