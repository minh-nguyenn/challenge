<template>
  <div class="wrap-content detail-info-custom">
    <main>
      ...
      <!-- v-html="infoDetail.body" -->
      <div class="textAC mobile-box text-left detail-data-custom" v-html="$transformImageSrc(infoDetail.body)"></div>
    </main>
...
export default {
  ...
  async setup() {
    ...
    const { params, $microcms, app } = buildLegacyContext()
