<template>
    <div class="wrap-content">
        <main>
            ...
            <AppArticle title="「個体識別番号」「ロット番号」とは">
                <div class="mobile-box">
                    ...
                    <section class="contentInner">
                        ...
                        <p>国内で生まれ、飼育された全ての牛に、10桁の番号が印字された標識が耳に着けられます。1頭1頭の生産から店頭までの履歴は、この番号により独立行政法人
                            家畜改良センターで識別・管理されています。</p>
                    </section>
            ...
            <AppButtonNavigation title="前のページへ戻る" class="btn-back btn-back-traceability" is-back href="/shop"></AppButtonNavigation>
        </main>
    </div>
</template>
