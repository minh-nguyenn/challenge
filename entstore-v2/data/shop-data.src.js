export const SHOP_SERVICES = {
  stamp: require('../assets/images/icon_stamp.webp'),
  post: require('../assets/images/icon_post.webp'),
  revenue: require('../assets/images/icon_revenue.webp'),
  alumi: require('../assets/images/alumi_service.webp'),
  paper: require('../assets/images/icon_paper.webp'),
  atm_toyokawa: require('../assets/images/icon_atm_toyokawa.webp'),
  atm_shizugin: require('../assets/images/icon_atm_shizugin.webp'),
  atm_hamashin: require('../assets/images/icon_atm_hamashin.webp'),
  atm_seven: require('../assets/images/icon_atm_seven.webp'),
  atm_etc: require('../assets/images/icon_atm_etc.webp'),
  transition: require('../assets/images/icon_transitionv2.webp'),
  bus: require('../assets/images/icon_bus.webp'),
  taxi: require('../assets/images/icon_taxi.webp'),
  photo: require('../assets/images/icon_photo.webp'),
  copy: require('../assets/images/icon_copy.webp'),
  eat: require('../assets/images/icon_eat.webp'),
  pizza: require('../assets/images/icon_pizza.webp'),
  pizza_pan: require('../assets/images/icon_pizza_pan.webp'),
  kids: require('../assets/images/icon_kids.webp'),
  kitchen: require('../assets/images/icon_kitchen.webp'),
  bakery: require('../assets/images/icon_bakery.webp'),
  amazonhub_locker: require('../assets/images/icon_amazonhub_locker.webp'),
  amazonhub_counter: require('../assets/images/icon_amazonhub_counter.webp'),
  pudo_station: require('../assets/images/icon_pudo_station.webp'),
  pay: require('../assets/images/icon_pay.webp'),
  shopping_agency: require('../assets/images/icon_shopping_agency.webp'),
  mobile_supermarket_hosoeinasa: require('../assets/images/icon_mobile_supermarket_hosoeinasa.webp'),
  mobile_supermarket_kasai: require('../assets/images/icon_mobile_supermarket_kasai.webp'),
  mobile_supermarket_kuno: require('../assets/images/icon_mobile_supermarket_kuno.webp'),
  mobile_supermarket_wagotomitsuka: require('../assets/images/icon_mobile_supermarket_wagotomitsuka.webp'),
  mobile_supermarket_mituke: require('../assets/images/icon_mobile_supermarket_mituke.webp'),
  mobile_supermarket_tenryu: require('../assets/images/icon_mobile_supermarket_tenryu.webp'),
  mobile_supermarket_kasai2: require('../assets/images/icon_mobile_supermarket_kasai2.webp'),
  mobile_supermarket_kasai3: require('../assets/images/icon_mobile_supermarket_kasai3.webp'),
  mobile_supermarket_kasai4: require('../assets/images/icon_mobile_supermarket_kasai4.webp'),
  mobile_supermarket_mikkabi: require('../assets/images/icon_mobile_supermarket_mikkabi.gif'),
  icon_supermarket_shinbashi: require('../assets/images/icon_supermarket_shinbashi.webp'),
  mobile_supermarket_tennou: require('../assets/images/icon_mobile_supermarket_tennou.webp'),
  mobile_supermarket_iwata: require('../assets/images/icon_supermarket_iwata.webp'),
  passto: require('../assets/images/icon_passto.webp'),

  food_tray_recycling: require('../assets/images/icon_food_tray_recyling.png'),
  paper_carton_recycling: require('../assets/images/icon_paper_carton_recycling.png'),
  plastic_bottle_recycling: require('../assets/images/icon_plastic_bottole_recyling.png'),
}
  ...
  chuoku: [
    {
      ...
      detail: {
        ...
        image: [
          {
            alt: '',
            url: require('../assets/images/photo01 (8).webp'),
          },
          {
            alt: '',
            url: require('../assets/images/photo02 (2).webp'),
          },
          {
            alt: '',
            url: require('../assets/images/photo03 (1).webp'),
          },
        ],
        googleMapUrl:
        ...
        tenant: [
          {
            name: 'ジャブ（クリーニング）',
            image: require('../assets/images/bnr_h-hakuyosha.webp'),
            detailTenantUrl: 'http://h-hakuyosha.com/',
          },
          {
            name: '遠鉄石油（ガソリンスタンド）',
            image: require('../assets/images/bnr_entetsusekiyu.webp'),
            detailTenantUrl: 'http://www.entetsusekiyu.co.jp/',
          },
          {
            name: 'かるん（パソコン教室）',
            image: require('../assets/images/bnr_karun.webp'),
            detailTenantUrl: 'https://karunchan.com/map/tomitsuka.html',
          },
          {
            name: 'ベルミーランド（エステサロン）',
            image: require('../assets/images/bnr_bellemeland.webp'),
    ...
    },
    {
      ...
      detail: {
        ...
        image: [
          {
            alt: '',
            url: require('../assets/images/photo01 (12).webp'),
          },
          {
            alt: '',
            url: require('../assets/images/photo02 (6).webp'),
          },
          {
            alt: '',
            url: require('../assets/images/photo03 (4).webp'),
          },
        ],
        googleMapUrl:
    ...
    },
    {
      ...
      detail: {
        ...
        image: [
          {
            alt: '',
            url: require('../assets/images/photo01 (23).webp'),
          },
          {
            alt: '',
            url: require('../assets/images/photo02 (17).webp'),
          },
          {
            alt: '',
            url: require('../assets/images/photo03 (11).webp'),
          },
        ],
        googleMapUrl:
    ...
    },
    {
      ...
      detail: {
        ...
        image: [
          {
            alt: '',
            url: require('../assets/images/photo01 (24).webp'),
          },
          {
            alt: '',
            url: require('../assets/images/photo02 (18).webp'),
          },
          {
            alt: '',
            url: require('../assets/images/photo03 (12).webp'),
          },
        ],
        googleMapUrl:
        ...
        tenant: [
          {
            name: 'マツモトキヨシ笠井店',
            image: require('../assets/images/bnr_matsukiyo.webp'),
            detailTenantUrl: 'http://www.matsukiyo.co.jp/',
          },
          {
            name: '玉華堂（菓子）',
            image: require('../assets/images/bnr_gyokkado.webp'),
          ...
          },
          {
            ...
            image: require('../assets/images/bnr_gamespot.webp'),
            detailTenantUrl: 'https://to-yu-2221.com/',
          },
          {
            name: '楽天モバイル リブロス笠井店',
            image: require('../assets/images/rakuten_mobile.jpg'),
            detailTenantUrl:
    ...
    },
    {
      ...
      detail: {
        ...
        image: [
          {
            alt: '',
            url: require('../assets/images/photo01 (9).webp'),
          },
          // {
          //   "alt": "",
          //   "url": require("../assets/images/photo02 (3).webp")
          // },
          {
            alt: '',
            url: require('../assets/images/photo03 (2).webp'),
          },
        ],
        googleMapUrl:
    ...
    },
    {
      ...
      detail: {
        ...
        image: [
          {
            alt: '',
            url: require('../assets/images/photo01 (10).webp'),
          },
          {
            alt: '',
            url: require('../assets/images/photo02 (4).webp'),
          },
          {
            alt: '',
            url: require('../assets/images/photo03 (3).webp'),
          },
        ],
        googleMapUrl:
        ...
        tenant: [
          {
            name: 'クリーニングのエブリ',
            image: require('../assets/images/bnr_cleaning-every.webp'),
    ...
    },
    {
      ...
      detail: {
        ...
        image: [
          {
            alt: '',
            url: require('../assets/images/photo01 (20).webp'),
          },
          {
            alt: '',
            url: require('../assets/images/photo02 (14).webp'),
          },
          {
            alt: '',
            url: require('../assets/images/photo03 (8).webp'),
          },
        ],
        googleMapUrl:
        ...
        busImage: [
          {
            alt: '無料送迎バス実施中',
            url: require('~/assets/images/bnr_bus_tateno.webp'),
            to: require('~/assets/pdf/bus_tateno.pdf'),
          },
        ],
      },
    },
    {
      ...
      detail: {
        ...
        image: [
          {
            alt: '',
            url: require('../assets/images/photo01 (28).webp'),
          },
          {
            alt: '',
            url: require('../assets/images/photo02 (22).webp'),
          },
          {
            alt: '',
            url: require('../assets/images/photo03 (15).webp'),
          },
        ],
        googleMapUrl:
    ...
    },
    {
      ...
      detail: {
        ...
        image: [
          {
            alt: '',
            url: require('../assets/images/shop/chuoku/oohitomi/photo01_lastest.webp'),
          },
          {
            alt: '',
            url: require('../assets/images/shop/chuoku/oohitomi/photo02_lastest.webp'),
          },
          {
            alt: '',
            url: require('../assets/images/shop/chuoku/oohitomi/photo03_lastest.webp'),
          },
        ],
        googleMapUrl:
        ...
        busImage: [
          {
            ...
            url: require('../assets/images/bnr_bus_oohitomi_yu.webp'),
            to: require('~/assets/pdf/bus_oohitomi_yuoohitomi.pdf'),
          },
          {
            alt: '無料送迎バス実施中　瞳ヶ丘行き',
            url: require('../assets/images/bnr_bus_oohitomi_hi.webp'),
            to: require('~/assets/pdf/bus_oohitomi_hitomigaoka.pdf'),
          },
        ],
      },
    },
    {
      ...
      detail: {
        ...
        image: [
          {
            alt: '',
            url: require('../assets/images/photo01 (25).webp'),
          },
          {
            alt: '',
            url: require('../assets/images/photo02 (19).webp'),
          },
          {
            alt: '',
            url: require('../assets/images/photo03 (13).webp'),
          },
        ],
        googleMapUrl:
        ...
        tenant: [
          ...
          {
            name: 'アサイー工房（アサイー専門店）',
            image: require('../assets/images/bnr_asai.webp'),
            detailTenantUrl:
    ...
    },
    {
      ...
      detail: {
        ...
        image: [
          {
            alt: '',
            url: require('../assets/images/photo01 (19).webp'),
          },
          {
            alt: '',
            url: require('../assets/images/photo02 (13).webp'),
          },
          {
            alt: '',
            url: require('../assets/images/photo03 (7).webp'),
          },
        ],
        googleMapUrl:
    ...
    },
    {
      ...
      detail: {
        ...
        image: [
          {
            alt: '',
            url: require('../assets/images/photo01 (21).webp'),
          },
          {
            alt: '',
            url: require('../assets/images/photo02 (15).webp'),
          },
          {
            alt: '',
            url: require('../assets/images/photo03 (9).webp'),
          },
        ],
        googleMapUrl:
        ...
        tenant: [
          ...
          {
            name: '買取大吉(買取サービス)',
            image: require('../assets/images/daikichi.webp'),
    ...
    },
    {
      ...
      detail: {
        ...
        image: [
          {
            alt: '',
            url: require('../assets/images/photo01 (18).webp'),
          },
          {
            alt: '',
            url: require('../assets/images/photo02 (12).webp'),
          },
        ],
        googleMapUrl:
    ...
    },
    {
      ...
      detail: {
        ...
        image: [
          {
            alt: '',
            url: require('../assets/images/sakuradai-left.jpg'),
          },
          {
            alt: '',
            url: require('../assets/images/sakuradai-center.jpg'),
          },
          {
            alt: '',
            url: require('../assets/images/sakuradai-right.jpg'),
          },
        ],
        googleMapUrl:
        ...
        busImage: [
          {
            ...
            url: require('../assets/images/bnr_bus_sakuradai.webp'),
            to: require('../assets/pdf/bus_sakuradai.pdf'),
          },
          {
            alt: '無料送迎バス 舘山寺行き実施中！',
            url: require('../assets/images/bnr_bus_sakuradai_ka.webp'),
            to: require('../assets/pdf/bus_sakuradai_kanzanji.pdf'),
          },
          {
            alt: '無料送迎バス 和地行き実施中！',
            url: require('../assets/images/bnr_bus_sakuradai_wa.webp'),
            to: require('../assets/pdf/bus_sakuradai_waji.pdf'),
          },
        ],
      },
    },
    {
      ...
      detail: {
        ...
        image: [
          {
            alt: '',
            url: require('../assets/images/photo01 (14).webp'),
          },
          {
            alt: '',
            url: require('../assets/images/photo02 (8).webp'),
          },
        ],
        googleMapUrl:
        ...
        tenant: [
          ...
          },
          {
            ...
            image: require('../assets/images/bnr_minamiasada_event.webp'),
            detailTenantUrl:
    ...
    },
    {
      ...
      detail: {
        ...
        image: [
          {
            alt: '',
            url: require('../assets/images/photo01 (13).webp'),
          },
          {
            alt: '',
            url: require('../assets/images/photo02 (7).webp'),
          },
        ],
        googleMapUrl:
        ...
        tenant: [
          {
            name: '杏林堂',
            image: require('../assets/images/bnr_kyorindo.webp'),
          ...
          {
            name: 'いずみ接骨院',
            image: require('../assets/images/bnr_izumi.webp'),
            detailTenantUrl: 'http://izumi-sekkotsuin.com',
          },
          {
            name: 'ランドリーカーサ',
            image: require('../assets/images/bnr_laundry_casa.webp'),
            detailTenantUrl: '',
          },
        ],
      },
    },
    {
      ...
      detail: {
        ...
        image: [
          {
            alt: '',
            url: require('../assets/images/photo01 (11).webp'),
          },
          {
            alt: '',
            url: require('../assets/images/takabayashi-1.jpg'),
          },
          {
            alt: '',
            url: require('../assets/images/takabayashi-2.jpg'),
          },
        ],
        googleMapUrl:
    ...
    },
    {
      ...
      shopBanner: {
        imgUrl: require('../assets/images/bnr_matsukiyo_dutyfree_kikugawa.jpg'),
        filePath: require('~/assets/pdf/dutyfree.pdf'),
      ...
      detail: {
        ...
        image: [
          {
            alt: '',
            url: require('../assets/images/photo01 (15).webp'),
          },
          {
            alt: '',
            url: require('../assets/images/photo02 (9).webp'),
          },
        ],
        googleMapUrl:
        ...
        tenant: [
          ...
          },
          {
            ...
            image: require('../assets/images/bnr_whattswith.webp'),
    ...
    },
    {
      ...
      detail: {
        ...
        image: [
          {
            alt: '',
            url: require('../assets/images/photo01 (22).webp'),
          },
          {
            alt: '',
            url: require('../assets/images/photo02 (16).webp'),
          },
          {
            alt: '',
            url: require('../assets/images/photo03 (10).webp'),
          },
        ],
        googleMapUrl:
    ...
    },
    {
      ...
      detail: {
        ...
        image: [
          {
            alt: '',
            url: require('../assets/images/photo01 (26).webp'),
          },
          {
            alt: '',
            url: require('../assets/images/photo02 (20).webp'),
          },
          {
            alt: '',
            url: require('../assets/images/photo03 (14).webp'),
          },
        ],
        googleMapUrl:
  ...
  hamanaku: [
    {
      ...
      detail: {
        ...
        image: [
          {
            alt: '',
            url: require('../assets/images/hamakita-1.webp'),
          },
          {
            alt: '',
            url: require('../assets/images/hamakita-2.webp'),
          },
          {
            alt: '',
            url: require('../assets/images/hamakita-3.webp'),
          },
        ],
        googleMapUrl:
    ...
    },
    {
      ...
      detail: {
        ...
        image: [
          {
            alt: '',
            url: require('../assets/images/kiratown_photo01.webp'),
          },
          {
            alt: '',
            url: require('../assets/images/kiratown_photo02.webp'),
          },
          {
            alt: '',
            url: require('../assets/images/kiratown_photo03.webp'),
          },
        ],
        googleMapUrl:
        ...
        tenant: [
          ...
          //   "image": require("../assets/images/bnr_urara.webp"),
        ...
        busImage: [
          {
            alt: '無料送迎バス実施中',
            url: require('~/assets/images/bnr_bus_kiraritown.webp'),
            to: require('~/assets/pdf/bus_kirari.pdf'),
          },
        ],
      },
    },
    {
      ...
      detail: {
        ...
        image: [
          {
            alt: '',
            url: require('../assets/images/photo01 (27).webp'),
          },
          {
            alt: '',
            url: require('../assets/images/photo02 (21).webp'),
          },
        ],
        googleMapUrl:
        ...
        tenant: [
          {
            name: 'ミーツ（100円均一ショップ）',
            image: require('../assets/images/bnr_meets.webp'),
    ...
    },
    {
      ...
      detail: {
        ...
        image: [
          {
            alt: '',
            url: require('../assets/images/shop/super-mikkabi/photo01.webp'),
          },
          {
            alt: '',
            url: require('../assets/images/shop/super-mikkabi/photo02.webp'),
          },
          {
            alt: '',
            url: require('../assets/images/shop/super-mikkabi/photo03.webp'),
          },
        ],
        googleMapUrl:
  ...
  tenryuku: [
    {
      ...
      detail: {
        ...
        image: [
          {
            alt: '',
            url: require('../assets/images/shop/tenryuku/photo01.webp'),
          },
          {
            alt: '',
            url: require('../assets/images/shop/tenryuku/photo02.webp'),
          },
          {
            alt: '',
            url: require('../assets/images/shop/tenryuku/photo03.webp'),
          },
        ],
        googleMapUrl:
  ...
  iwatashi: [
    {
      ...
      detail: {
        ...
        image: [
          {
            alt: '',
            url: require('../assets/images/photo01 (31).webp'),
          },
          {
            alt: '',
            url: require('../assets/images/photo02 (25).webp'),
          },
          {
            alt: '',
            url: require('../assets/images/photo03 (18).webp'),
          },
        ],
        googleMapUrl:
    ...
    },
    {
      ...
      detail: {
        ...
        image: [
          {
            alt: '',
            url: require('../assets/images/photo01 (32).webp'),
          },
          {
            alt: '',
            url: require('../assets/images/photo02 (26).webp'),
          },
          {
            alt: '',
            url: require('../assets/images/photo03 (19).webp'),
          },
        ],
        googleMapUrl:
    ...
    },
    {
      ...
      detail: {
        ...
        image: [
          {
            alt: '',
            url: require('../assets/images/店舗外観.webp'),
          },
          {
            alt: '',
            url: require('../assets/images/店内売場.webp'),
          },
          {
            alt: '',
            url: require('../assets/images/マツキヨ外観.webp'),
          },
        ],
        googleMapUrl:
    ...
    },
    {
      ...
      detail: {
        ...
        image: [
          {
            alt: '',
            url: require('../assets/images/photo01 (34).webp'),
          },
          {
            alt: '',
            url: require('../assets/images/photo02 (28).webp'),
          },
          {
            alt: '',
            url: require('../assets/images/photo03 (21).webp'),
          },
        ],
        googleMapUrl:
        ...
        tenant: [
          ...
          {
            name: '買取専門いくらや',
            image: require('../assets/images/mitsuke.jpg'),
  ...
  hukuroishi: [
    {
      ...
      detail: {
        ...
        image: [
          {
            alt: '',
            url: require('../assets/images/photo01 (35).webp'),
          },
          {
            alt: '',
            url: require('../assets/images/photo02 (29).webp'),
          },
          {
            alt: '',
            url: require('../assets/images/photo03 (22).webp'),
          },
        ],
        googleMapUrl:
    ...
    },
    {
      ...
      detail: {
        ...
        image: [
          {
            alt: '',
            url: require('../assets/images/shop/hukuroishi/kuno/20240425_49号店①.webp'),
          },
          {
            alt: '',
            url: require('../assets/images/shop/hukuroishi/kuno/20240425_49号店②.webp'),
  ...
  kakegawashi: [
    {
      ...
      detail: {
        ...
        image: [
          {
            alt: '',
            url: require('../assets/images/photo01 (37).webp'),
          },
          {
            alt: '',
            url: require('../assets/images/photo02 (30).webp'),
          },
          {
            alt: '',
            url: require('../assets/images/photo03 (23).webp'),
          },
        ],
        googleMapUrl:
  ...
  kikugawashi: [
    {
      ...
      shopBanner: {
        imgUrl: require('../assets/images/bnr_matsukiyo_dutyfree_kikugawa_2.jpg'),
        filePath: require('~/assets/pdf/dutyfree.pdf'),
        alt: 'マツモトキヨシ（松本清）菊川店 免税対応：Tax-free 8％OFF！',
      },
      detail: {
        ...
        image: [
          {
            alt: '',
            url: require('../assets/images/photo01 (39).webp'),
          },
          {
            alt: '',
            url: require('../assets/images/photo03 (25).webp'),
          },
          {
            alt: '',
            url: require('../assets/images/photo04 (1).webp'),
          },
        ],
        googleMapUrl:
        ...
        tenant: [
          ...
          {
            name: 'シャトレーゼ',
            image: require('../assets/images/bnr_chateraise.webp'),
            detailTenantUrl: 'https://www.chateraise.co.jp/ec/shop/o618060/',
          },
          {
            name: 'カーサカラー（ヘアカラー）',
            image: require('../assets/images/CASA73.webp'),
  ...
  kosaishi: [
    {
      ...
      detail: {
        ...
        image: [
          {
            alt: '',
            url: require('../assets/images/photo01 (40).webp'),
          },
          {
            alt: '',
            url: require('../assets/images/photo02 (32).webp'),
          },
          {
            alt: '',
            url: require('../assets/images/photo03 (26).webp'),
          },
        ],
        googleMapUrl:
  ...
  toyokawashi: [
    {
      ...
      detail: {
        ...
        image: [
          {
            alt: '',
            url: require('../assets/images/photo01 (41).webp'),
          },
          {
            alt: '',
            url: require('../assets/images/photo02 (33).webp'),
          },
          {
            alt: '',
            url: require('../assets/images/photo03 (27).webp'),
          },
        ],
        googleMapUrl:
        ...
        tenant: [
          ...
          {
            name: 'Can Do（100円均一）',
            image: require('../assets/images/bnr_cando.webp'),
            detailTenantUrl: 'http://www.cando-web.co.jp/',
          },
          {
            name: 'クリーニングアポロ',
            image: require('../assets/images/bnr_apollo.webp'),
            detailTenantUrl: '',
          },
          {
            name: '遠鉄ストア豊川店 イベントスペース出店者 募集案内',
            image: require('../assets/images/bnr_toyokawa_event.webp'),
  ...
  toyohashishi: [
    {
      ...
      detail: {
        ...
        image: [
          {
            alt: '',
            url: require('../assets/images/photo01 (42).webp'),
          },
          {
            alt: '',
            url: require('../assets/images/photo02 (34).webp'),
          },
          {
            alt: '',
            url: require('../assets/images/photo03 (28).webp'),
          },
        ],
        googleMapUrl:
  ...
  shuchigun: [
    {
      ...
      detail: {
        ...
        image: [
          {
            alt: '',
            url: require('../assets/images/mori-1.jpg'),
          },
          {
            alt: '',
            url: require('../assets/images/mori-2.jpg'),
          },

          {
            alt: '',
            url: require('../assets/images/mori-3.jpg'),
          },
        ],
        googleMapUrl:
